...
if($oper == '+'){
   ...
   <input type=text size=5 name=argument1 ></td><td align=center> $oper <input type=hidden name=oper value=$oper></td><td align=center> <input type=text name=argument2 size=5></td><td>=</td><td><input type=text name='result' value='' size='5'> </td></tr></table><input type=submit value='submit'>";
}else{
   echo "</td></tr><tr ><td align=center>
   <input type=text name=argument1 size=5></td><td align=center> $oper <input type=hidden name=oper value=$oper></td><td align=center> <input type=text name=argument2 size=5></td><td>=</td><td><input type=text name='result' value='' size='5'> </td></tr></table><input type=submit value='submit'>";
}
}else{
   echo " <input type=text name=argument1 size=5><input type=hidden name=oper value=$oper><input type=text name=argument2 size=5><input type=text name='result' value='' size='5'> </td></tr></table><br><input type=submit value='submit'>";
